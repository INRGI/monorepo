  ...
  const handleBuyBox = async (rarity: string, price: number) => {
    try {
      const response = await axios.post(
        `http://localhost:3000/shop/buyByRarity/${rarity}`,
        {
          hero: hero,
          price,
        }
  ...
  return (
    <Container>
      ...
      <BoxesContainer>
        <BoxCard key={1}>
          <img
            src="https://cdnb.artstation.com/p/assets/images/images/044/580/393/original/fouraugustx-cm-lootbox.gif?1640491778"
            alt="Box"
          />
          <h4>Common</h4>
          <p>Cost: 50 coins</p>
        ...
        <BoxCard key={2}>
          <img
            src="https://t3.ftcdn.net/jpg/05/89/06/24/360_F_589062467_dUdYOcF9DrYSfwstki995HRSEAgwo5Xw.jpg"
            alt="Box"
          />
          <h4>Rare</h4>
          <p>Cost: 300 coins</p>
        ...
        <BoxCard key={3}>
          <img
            src="https://i.pinimg.com/originals/88/1a/98/881a988f92d5a2d602e881f8d4f699f7.gif"
            alt="Box"
          />
          <h4>Epic</h4>
          <p>Cost: 700 coins</p>
        ...
        <BoxCard key={4}>
          ...
          <button onClick={() => handleBuyBox('legendary', 50000)}>
            Buy Box
          </button>
        </BoxCard>
      </BoxesContainer>
